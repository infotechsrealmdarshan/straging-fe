...
class PanoramaCapture extends Component {
    constructor(props) {
        ...
        // PIXEL-PERFECT GRID: extra rings near poles to reduce stitching cut-off and pole distortion
        const LAYERS = [
            { id: 'zenith', pitch: 90, cols: 1, offset: 0 },
            { id: 'sky_cap', pitch: 75, cols: 6, offset: 0 },
            ...
            { id: 'floor_cap', pitch: -75, cols: 6, offset: 0 },
